import { Component, ElementRef, NgZone, ChangeDetectorRef, ViewChild, Renderer2, DoCheck, OnInit } from '@angular/core';
...
export class TickComponent implements DoCheck, OnInit {
